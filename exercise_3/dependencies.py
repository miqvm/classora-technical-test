...
from exercise_3.infrastructure.external.virustotal_client import (
    VirusTotalEnrichmentService,
)
...
enrichment_service = VirusTotalEnrichmentService(
   api_key=settings.virustotal_api_key  # Make sure you add this to config.py!
)
